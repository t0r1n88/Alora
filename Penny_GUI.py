...
from generate_sertificat_prof_2026 import generate_docs_from_template
...
"""
Функции для обработки файла тестирования
"""
...
def select_data_bnp():
    ...
    global data_bnp
    # Получаем путь к файлу
    data_bnp = filedialog.askopenfilename(filetypes=(('Excel files', '*.xlsx'), ('all files', '*.*')))

def select_end_folder_bnp():
    """
    Функция для выбора конечной папки куда будут складываться итоговые файлы
    :return:
    """
    global path_to_end_bnp
    path_to_end_bnp = filedialog.askdirectory()


def processing_create_result_bnp():
    """
    Функция для генерации документов
    """
    try:
        generate_result_bnp(data_bnp,path_to_end_bnp)
...
"""
Функции для обработки данных для дашборда приемной кампании
"""


def select_data_priem_dash():
    """
    Функция для выбора файла с данными на основе которых будет генерироваться документ
    :return: Путь к файлу с данными
    """
    global data_priem_dash
    # Получаем путь к файлу
    data_priem_dash = filedialog.askopenfilename(filetypes=(('Excel files', '*.xlsx'), ('all files', '*.*')))

def select_end_folder_priem_dash():
    """
    Функция для выбора конечной папки куда будут складываться итоговые файлы
    :return:
    """
    global path_to_end_priem_dash
    path_to_end_priem_dash = filedialog.askdirectory()


def processing_create_result_priem_dash():
    """
    Функция для генерации документов
    """
    try:
        generate_data_for_dash_priem(data_priem_dash,path_to_end_priem_dash)
...
def select_data_yandex_priem_dash():
    """
    Функция для выбора файла с данными на основе которых будет генерироваться документ
    :return: Путь к файлу с данными
    """
    global data_yandex_priem_dash
    # Получаем путь к файлу
    data_yandex_priem_dash = filedialog.askopenfilename(filetypes=(('Excel files', '*.xlsx'), ('all files', '*.*')))

def select_end_folder_yandex_priem_dash():
    """
    Функция для выбора конечной папки куда будут складываться итоговые файлы
    :return:
    """
    global path_to_end_yandex_priem_dash
    path_to_end_yandex_priem_dash = filedialog.askdirectory()


def processing_create_result_yandex_priem_dash():
    """
    Функция для генерации документов
    """
    try:
        generate_data_for_priem_yandex(data_yandex_priem_dash,path_to_end_yandex_priem_dash)
...
"""
Для создания грамот по викторине
"""
