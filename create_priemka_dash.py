...
def generate_data_for_dash_priem(data_file:str,end_folder:str):
    ...
    try:
        ...
        dash_spo_df['short_title'] = dash_spo_df['short_title'].replace({'Татауровский филиал ГБПОУ "БКТИС"':'ГБПОУ "БКТИС"','Могойтинский филиал ГБПОУ "БКТИС"':'ГБПОУ "БКТИС"',
                                                                         'Усть-Баргузинский филиал ГБПОУ "БКТИС"':'ГБПОУ "БКТИС"',
                                                                         'Тарбагатайский филиал ГБПОУ "БКТИС"':'ГБПОУ "БКТИС"',
                                                                         'Мухоршибирский филиал ГБПОУ "БКН"':'ГБПОУ "БКН"','Баунтовский филиал ГБПОУ "БКН"':'ГБПОУ "БКН"',
                                                                         'Кяхтинский филиал ГАПОУ "ББМК МЗ РБ"':'ГАПОУ "ББМК МЗ РБ"',
                                                                         'Хоронхойский филиал ГБПОУ "БРТСИПТ"':'ГБПОУ "БРТСИПТ"',
                                                                         'Бичурский филиал ГАПОУ РБ "РМТ"':'ГАПОУ РБ «РМТ»',
                                                                         'Новобрянский филиал ГАПОУ РБ "РМТ"':'ГАПОУ РБ «РМТ»',
                                                                         'Кижингинский филиал ГБПОУ «Бурятский аграрный колледж им. М. Н. Ербанова»':'ГБПОУ «Бурятский аграрный колледж им. М. Н. Ербанова',
                                                                         'Муйский филиал ГАПОУ РБ "БРМТИТ"':'ГАПОУ РБ «БРМТИТ»',
                                                                         'Онохойский филиал ГАПОУ РБ "БРТАТ"':'ГАПОУ РБ "БРТАТ"',
                                                                         'Сосново-Озерский филиал ГБПОУ "Байкальский колледж недропользования"':'ГБПОУ "БКН"',
                                                                         'Тункинский филиал ГБПОУ "БРИЭТ"':'ГБПОУ «БРИЭТ»',
                                                                         'Хоринский филиал ГБПОУ "Бурятский республиканский индустриальный техникум"':'ГБПОУ "Бурятский республиканский индустриальный техникум"',
                                                                         })
